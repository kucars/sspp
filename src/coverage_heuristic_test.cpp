...
int main( int argc, char **  argv)
{
    ...
    double coverageTolerance=1.0, targetCov=90;
...
//        pathPlanner->printNodeList();
    ...
    ss << targetCov;
    cc <<regGridConRad;
    std::string file_loc = ros::package::getPath("sspp")+"/resources/"+cc.str()+"_"+ss.str()+"%path_newtests1to4_"+occlusionCullingModelName+"IGGPU_DynamicNew.txt";
