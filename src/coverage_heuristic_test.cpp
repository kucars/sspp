...
//    sensors.push_back(sensor2);
    ...
    CoveragePathPlanningHeuristic coveragePathPlanningHeuristic(nh,collisionCheckModelPath,occlusionCullingModelName,false, false, InfoGainVolumetricH);
...
//        pathPlanner->printNodeList();
    ...
    ss << targetCov;
    cc <<regGridConRad;
    std::string file_loc = ros::package::getPath("sspp")+"/resources/"+cc.str()+"_"+ss.str()+"%path_newtests1to4_"+occlusionCullingModelName+"volumetricNOGPU.txt";
